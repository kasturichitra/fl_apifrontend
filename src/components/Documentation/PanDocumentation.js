...
const PanDocumentation = () => {
  ...
  return (
    <div className="text-dark card p-4">
      <h2 className="text-center">Pan Number Documentation</h2>
      <p>Here is the documentation for the Pan Number field Implementation</p>
      <p>{data?.Fstep}</p>
      <div>
        <h3>{data?.Overview}</h3>
        <p>
          You can know the pan details of a person with this Pan Verification
          API
        </p>
...
export default PanDocumentation;
