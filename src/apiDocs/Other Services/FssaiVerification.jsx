...
import { FV, NM } from "../../utils/bodyParams";
    ...
    <div className="main_parent">
      <div className="first_child hide-scrollbar">
        ...
        <div className="api_hero">
          <h1 className="api_heading">Fssai Verification</h1>
          <MethodLink
            method="POST"
            className="method_link"
            LinkClass="link_class"
            link="common/FSSAI/Verify"
          />
          <p className="first_para">
            The FSSAI Verification API allows developers to verify the
            authenticity of FSSAI licenses in real-time, ensuring that food
            businesses are legally registered.
          </p>
          <p className="first_para">
            Provides details such as license number, status, and validity for
