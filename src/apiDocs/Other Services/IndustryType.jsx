    ...
    <div className="main_parent">
      <div className="first_child hide-scrollbar">
        ...
        <div className="api_hero">
          <h1 className="api_heading">Industry Type</h1>
          <MethodLink
            method="POST"
            className="method_link"
            LinkClass="link_class"
            link="common/know/industryType"
          />
          <p className="first_para">
            The Industry Type API allows developers to identify and verify the
            business sector or industry classification of a company in
            real-time.
          </p>
          <p className="first_para">
            Provides standardized industry codes and descriptions for
            compliance, analytics, and business insights.
          </p>
        </div>
