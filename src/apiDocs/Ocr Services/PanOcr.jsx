...
import { PNV, POCR } from "../../utils/bodyParams";
...
const PanOcr = () => {
  ...
  const examplesList = GetAcc?.exampleCodes["POCR"] || [];
    ...
    <div className="main_parent">
      <div className="first_child hide-scrollbar">
        ...
        <div className="api_hero">
          <h1 className="api_heading">Pan Ocr</h1>
          <MethodLink
            method="POST"
          ...
          <p className="first_para">
            The PAN OCR API allows developers to extract PAN details from images
            or scanned copies of PAN cards in real-time.
          </p>
        </div>
      ...
      <div className="second_child hide-scrollbar">
        <Codes
          ...
          service={"pan"}
          examples={GetAcc?.exampleCodes["POCR"] || []}
        />
      </div>
    </div>
  );
