...
const VoterIdVerify = () => {
  ...
  const examplesList = GetAcc?.exampleCodes["VIV"] || [];
    ...
    <div className="main_parent">
      <div className="first_child hide-scrollbar">
        ...
        <div className="api_hero">
          <h1 className="api_heading">Voter Id Verify</h1>
          <MethodLink
            method="POST"
            className="method_link"
            LinkClass="link_class"
            link="government/voterId/verify"
          />
          <p className="first_para">
            The Voter ID Verification API allows developers to validate voter ID
            details and retrieve associated information, enabling real-time
            verification of voter identity and electoral records.
          </p>
        </div>
      ...
      <div className="second_child hide-scrollbar">
        <Codes
          ...
          service={"voterId"}
          examples={GetAcc?.exampleCodes["VIV"] || []}
        />
      </div>
    </div>
  );
