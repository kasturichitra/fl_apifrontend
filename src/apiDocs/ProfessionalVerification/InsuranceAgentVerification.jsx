...
const InsuranceAgentVerification = () => {
  const [faceMatchState, setFaceMatchState] = useState({});
  const [apiResponse, setApiResponse] = useState(null);
  const [allRequiredFields, setAllRequiredFields] = useState({});

  const examplesList = GetAcc?.exampleCodes["IAV"] || [];
    ...
    <div className="main_parent">
      <div className="first_child hide-scrollbar">
        ...
        <div className="api_hero">
          <h1 className="api_heading">Insurance Agent Verification</h1>
          <MethodLink
            method="POST"
            className="method_link"
            LinkClass="link_class"
            link="professional/Insurance/verify"
          />
          <p className="first_para">
            The Insurance Agent Verification API enables developers to verify
            the authenticity of insurance agents in real-time using their
            professional details, ensuring compliance and reducing fraud.
          </p>
        </div>
      ...
      <div className="second_child hide-scrollbar">
        <Codes
          ...
          service={"insuranceAgentVerification"}
          examples={GetAcc?.exampleCodes["IAV"] || []}
        />
      </div>
    </div>
  );
...
export default InsuranceAgentVerification;
