    ...
    <div className="main_parent">
      <div className="first_child hide-scrollbar">
        ...
        <div className="api_hero">
          <h1 className="api_heading">Domain Verification</h1>
          <MethodLink
            method="POST"
            className="method_link"
            LinkClass="link_class"
            link="diligence/domain/verify"
          />
          <p className="first_para">
            The Domain Verification API allows developers to verify the
            ownership and authenticity of a domain in real-time.
          </p>
          <p className="first_para">
            Domain Verification ensures that the domain is valid and controlled
            by the claimed owner.
          </p>
          <p className="first_para">
            It is essential for email authentication, SSL issuance, and other
