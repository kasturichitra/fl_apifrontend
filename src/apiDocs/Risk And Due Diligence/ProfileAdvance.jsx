    ...
    <div className="main_parent">
      <div className="first_child hide-scrollbar">
        ...
        <div className="api_hero">
          <h1 className="api_heading">Profile Advance</h1>
          <MethodLink
            method="POST"
            className="method_link"
            LinkClass="link_class"
            link="diligence/advance/profile"
          />
          <p className="first_para">
            The Profile Advance API allows developers to access enhanced user
            profile information for verification and analytics in real-time.
          </p>
          <p className="first_para">
            Provides comprehensive details such as identity attributes, contact
