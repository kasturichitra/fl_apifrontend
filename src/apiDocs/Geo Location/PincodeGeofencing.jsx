...
const PincodeGeofencing = () => {
  ...
  const examplesList = GetAcc?.exampleCodes["PCG"] || [];
    ...
    <div className="main_parent">
      <div className="first_child hide-scrollbar">
        ...
        <div className="api_hero">
          <h1 className="api_heading">Pincode Geofencing</h1>
          <MethodLink
            method="POST"
          ...
          <p className="first_para">
            ...
            geographic boundaries based on pincodes, enabling real-time
        ...
        <div className="py-6">
          ...
          <ResponseComponent
            dynamic200={pincodeGeofencingDynamic}
            otherData={DATA}
          />
        </div>
      </div>
      ...
      <div className="second_child hide-scrollbar">
        <Codes
          ...
          service={"pincodeGeofencing"}
          examples={GetAcc?.exampleCodes["PCG"] || []}
        />
      </div>
    </div>
  );
...
export default PincodeGeofencing;
