...
import { UDYAM, UDYOGWITHPHONE } from "../../utils/bodyParams";
    ...
    <div className="main_parent">
      <div className="first_child hide-scrollbar">
        ...
        <div className="api_hero">
          <h1 className="api_heading">Udyog Aadhaar Using Phone</h1>
          <MethodLink
            method="POST"
            className="method_link"
            LinkClass="link_class"
            link="business/udyog/phoneAadhaar/verify"
          />
          <p className="first_para">
            The Udyog Aadhaar Using Phone API enables developers to verify Udyog
            Aadhaar details using a registered mobile number in real-time,
            simplifying MSME validation and onboarding.
          </p>
        </div>
      ...
      <div className="second_child hide-scrollbar">
        <Codes
          ...
          service={"udyogAadhaarUsingPhone"}
...
export default UdyogAadhaarUsingPhone;
