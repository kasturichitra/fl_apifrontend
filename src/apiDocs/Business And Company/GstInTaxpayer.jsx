...
import { BAV, GSTIN } from "../../utils/bodyParams";
...
const GstInTaxpayer = () => {
  ...
  const examplesList = GetAcc?.exampleCodes["GST_TAX_PAY"] || [];
    ...
    <div className="main_parent">
      ...
      <div className="second_child hide-scrollbar">
        <Codes
          ...
          examples={GetAcc?.exampleCodes["GST_TAX_PAY"] || []}
        />
      </div>
    </div>
  );
