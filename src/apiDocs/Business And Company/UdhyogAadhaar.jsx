...
import { UDYAM, UDYOG } from "../../utils/bodyParams";
    ...
    <div className="main_parent">
      <div className="first_child hide-scrollbar">
        ...
        <div className="api_hero">
          <h1 className="api_heading">Udyog Aadhaar Verification</h1>
          <MethodLink
            method="POST"
            className="method_link"
            LinkClass="link_class"
            link="business/udyogAadhaar/verify"
          />
          <p className="first_para">
            The Udyog Aadhaar Verification API enables developers to verify the
            authenticity of Udyog Aadhaar numbers in real-time, helping validate
